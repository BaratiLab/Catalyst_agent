...
def ocp_adslab_generator(
    ...
    if isinstance(slab, Atoms):
        # The slab Atoms coming from relaxations are already tiled/tagged; avoid
        # enforcing the default min_ab=8.0 assertion here.
        slab = Slab(slab_atoms=slab, min_ab=0.0)
